...
// const radioButton = document.querySelector('.type_radio_batton');
...
function addItem() {
  // Получение префикса из поля ввода и очистка от лишних пробелов
...
// Обработчик события для кнопки удаления выбранных строк
...
// console.log(document.querySelector('#addItemButton').parentElement);
// Функция для удаления выбранных строк из списка
